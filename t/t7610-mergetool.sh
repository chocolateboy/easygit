...
test_expect_success 'setup' '
    ...
    git add file11 &&
    git commit --staged -m "stash1 changes" &&

    git checkout -b stash2 master &&
    echo stash2 change file11 >file11 &&
    git add file11 &&
    git commit --staged -m "stash2 changes" &&
...
test_expect_success 'deleted vs modified submodule' '
    ...
    git commit -b -m "Submodule deleted from branch" &&
    ...
    output="$(git mergetool --no-prompt)" &&
    test "$output" = "No files need merging" &&
    git commit -b -m "Merge resolved by keeping module" &&
    ...
    output="$(git mergetool --no-prompt)" &&
    test "$output" = "No files need merging" &&
    git commit -b -m "Merge resolved by deleting module" &&
...
test_expect_success 'file vs modified submodule' '
    ...
    git add submod &&
    git commit -b -m "Submodule path becomes file" &&
    ...
    output="$(git mergetool --no-prompt)" &&
    test "$output" = "No files need merging" &&
    git commit -b -m "Merge resolved by keeping file" &&
...
test_expect_success 'directory vs modified submodule' '
    ...
    git commit -b -m "Submodule path becomes directory" &&
